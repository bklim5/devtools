// Hash Generator — registered as a placeholder in Wave 1 (Plan 04-01) so registry.ts
// edits are concentrated here; Wave 2 (Plan 04-04) swaps `component` for the real
...
export const hashTool: ToolDefinition = {
  ...
  icon: Hash,
  component: makePlaceholder("Hash"),
  enabled: true,
};
