...
---
*Last updated: 2026-06-03 — Milestone v1.3 "More Tools": **Phase 12 "Protobuf decimal input" COMPLETE & verified** (6/6 must-haves; PRO-08/PRO-09; decimal byte-array as a third auto-detected Protobuf input mode; `decoder.ts` + 19 tests untouched; 522/522 tests, gsd-ui-review 24/24 WCAG-AA PASS, `tauri build` signed off). Next: Phase 13 "URL tool". Milestone v1.3 STARTED (promotes backlog 999.1: Cron + URL + Regex tools + Protobuf decimal-byte-array input; eight tools → eleven; phases 12–15). Previous: Milestone v1.2 "Release Tooling" COMPLETE (Phases 9–11, all verified). Phase 11 (`build-and-publish` driver + universal binary) complete & verified; `pnpm release:publish` live-proven (real v0.2.2 published to bklim5/devtools-releases + DST-02 updater round-trip confirmed on Apple Silicon). All 12 REL requirements complete; CI track parked in backlog 999.2. Previous: Phase 10 `bump-and-tag` complete; Phase 9 pure release core complete; v1.1 "Formatters" archived, tagged v1.1*
